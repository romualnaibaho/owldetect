...
func main() {
	...
	http.HandleFunc("/analysis", func(w http.ResponseWriter, r *http.Request) {
		...
		err = detector.DetectWithStrings(reqBody.InputText, reqBody.RefText)
		if err != nil {
			WriteAPIResp(w, NewErrorResp(err))
			return
		}
